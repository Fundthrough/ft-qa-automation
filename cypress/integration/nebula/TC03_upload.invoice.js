...
describe('upload invoice from dashboard', () => {
        ...
        it('SignIn with Valid Credential', function test() {
                ...
                function uploadinvoice() {
                        signinElements.customerPage.getcardcontent().then(($element) => {
                                signinElements.customerPage.getuploadinvoice()
                                ...
                                cy.get('.message').then(($m) => {
                                        ...
                                        signinElements.customerPage.getbuttonuploadinvoice().click({
                                                force: true
                                        })
                                        cy.wait(2000);
                                });

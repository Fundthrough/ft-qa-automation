...
export const signUpTexts = {
    ...
    quickBooksHeader:
        'Add your invoices from QuickBooks and start funding them in less than 24 hours.',
    businessLegalName:
...
export class SignUpPage {
    ...
    fillPasswordInput(password) {
        cy.get(signUpSelectors.userPassword).should('be.visible').type(password)

        return this
    }

    clearPasswordInput() {
        cy.get(signUpSelectors.userPassword).should('be.visible').clear()
    ...
    inputBusinessName(value) {
        cy.get(signUpSelectors.businessName).should('exist').type(value)
    ...
    checkAddressField() {
        cy.get(signUpSelectors.secondAddress).should('exist').and('be.empty')
